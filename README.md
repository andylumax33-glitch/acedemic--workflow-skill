...
- `academic-workflow-router/SKILL.md`：路由规则与交接约束
- `academic-workflow-router/references/priority-map.md`：主 Skill 优先级表和验收场景
...
将 `academic-workflow-router` 整个目录复制到对应的 Skill 根目录，不要只复制 `SKILL.md`：

```text
Codex       .agents/skills/academic-workflow-router/
Claude Code .claude/skills/academic-workflow-router/
Trae        .trae/skills/academic-workflow-router/
```

也可以安装到用户级 Codex Skill 目录：

```text
~/.codex/skills/academic-workflow-router/
```
